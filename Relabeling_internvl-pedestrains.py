...
def main():
    ...
    prompt1 = """<image>\nYou are an expert in autonomous driving, specializing in analyzing traffic scenes.                
                Your task is to look at the human beings in the image and output the response in the format below. think step by step before deciding the answer and return only ONE word answer
                Strictly follow the rules.
                {
                    [Choose ONE category among the following for the most dominant object in the bounding box: "person", "bicyclist", "motorcyclist", "other rider"]                
                }"""

    prompt2 = """<image>\nYou are an expert in autonomous driving, specializing in analyzing traffic scenes.                
                Your task is to look at the  human beings in the red bbox  and output the response in the format below. think step by step before deciding the answer and return only ONE word answer
                Strictly follow the rules.
                {
                    [Choose ONE category among the following for the most dominant object in the bounding box: "person", "bicyclist", "motorcyclist", "other rider"]
                }"""
    ...
    with open('%s_pedestrains.json'%save_path, 'w') as f:
