...
def main():
    ...
    # parser.add_argument('--subdir', required=True, help='Single subdirectory to process')
    ...
    prompt1 = """<image>\nYou are an expert in autonomous driving, specializing in analyzing traffic scenes.                
                ...
                {
                    [Choose ONE category among the following for the most dominant object in the bounding box: "car", "SUV", "bus", "truck", "bicycle", "motorcycle"]                
                }"""
    ...
    prompt2 = """<image>\nYou are an expert in autonomous driving, specializing in analyzing traffic scenes.                
                ...
                Strictly follow the rules.
                {
                    [Choose ONE category among the following for the most dominant object in the bounding box: "car", "bus", "SUV", "truck", "bicycle", "motorcycle"]                
                }"""
            ...
            for j in cat_image:
                if j['category'] in valid_cats:
                    if 'box2d' in j:
                        ...
                        Image.fromarray(cropped_image).save('crp-2.png') 
    ...
    with open('%s_vehicles_bdd.json'%save_path, 'w') as f:
        json.dump(results, f, indent=2)

    with open('%s_vehicles_bdd.txt'%save_path, 'w') as f:
